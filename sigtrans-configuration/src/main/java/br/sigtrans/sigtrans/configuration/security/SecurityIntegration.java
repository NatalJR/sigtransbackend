package br.sigtrans.sigtrans.configuration.security;
...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(br.sigtrans.sigtrans.configuration.security.SecurityIntegration.class);
     ...
     */
    public static final String BASE = ".*sigtrans-api.api";

    /**
     * Operações do Software
     */
    public static final List<OperationExpression> operations = Arrays.asList(
            new OperationExpression("CRUD-sigtrans", BASE + ".*", ".*")
    );
